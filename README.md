...
``` bash
curl -s https://raw.githubusercontent.com/RogerP993/odoo-16-docker-compose/master/run.sh | sudo bash -s odoo-one 10016 20016
```
...
``` bash
curl -s https://raw.githubusercontent.com/RogerP993/odoo-16-docker-compose/master/run.sh | sudo bash -s odoo-two 11016 21016
```
